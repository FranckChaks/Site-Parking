    ...
    <div class="row">
        <div class="col-xs-12 col-lg-12 padding_0">
            <img class="img_responsive" width="100% 100%"  src="css/item1.jpg">
        </div>
    </div>
 <div class="container">    
<div class="row">
...
<div class="row">
    ...
    <div class="col-xs-12 col-lg-12 text-center2">
           <p><h1>Ce site est fait pour vous</h1><br>
           Acceptez l'offre premium pour seulement 1000€/jour !</p>
            <img class="img_responsive2" width="70%" height="80%"  src="css/item2.jpg">
        </div>
